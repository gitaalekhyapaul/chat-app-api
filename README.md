...
2.  ### **/api/auth/register => POST Route**
    > - HTTP Method: POST
    > - Authorization: None
    > - Request Type: application/x-www-form-urlencoded
    > - **Request Parameters:**
...
4.  ### **/api/chats/send => POST Route**
    ...
    > - **Request Parameters:**
    >
    > 1. Parameter Name: content  
    >    Requirement: Yes  
    >    Data Type: String  
    >    Description: Chat with usertags as **SPECIFIED BELOW FORMAT**
    >
    > - **Request Headers:**
    >
    > 1. Header: Authorization  
...
# **API Note Content Specification:**
